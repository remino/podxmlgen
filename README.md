...
```
Usage: podxmlgen [options] input_dir
...
Available options:
	...
	-a          Name of podcast author. Defaults to "podxmlgen".
	...
	-i          Image URL.
	-k          iTunes keywords, separated by commas. Defaults to "podxmlgen".
	-l          Language and region (e.g. fr-ca). Defaults to "en-ca".
	...
	-x          Whether or not podcast is explicit ("yes" or "no"). Defaults to "no".
```
